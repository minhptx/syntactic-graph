...
ATOMIC_LIST = [PROPER_CASE, UPPER_CASE, LOWER_CASE, DIGIT, ALPHABET, ALPHANUM, WHITESPACE, PUNCTUATION]

TOKEN_TYPES = [UPPER_CASE, LOWER_CASE, WHITESPACE, PUNCTUATION, DIGIT]

#  PROPER_CASE_WS, LOWER_CASE_WS, UPPER_CASE_WS, ALPHABET_WS, ALPHANUM
